...
df <- read_csv('C:/Users/jiaxins/OneDrive - University of Tasmania/PhD/TPC/populations_TPC.csv', show_col_types = FALSE)
...
# mark realised Tmax ------------------------------------------------------
nc_sst <- nc_open("C:/Users/jiaxins/OneDrive - University of Tasmania/PhD/Data/kelp/temp/real_sst_lab_tmax.nc")
...
p_final
ggsave("C:/Users/jiaxins/OneDrive - University of Tasmania/PhD/research paperwork/Chapter 2/Figures/thermal_performance_R_eb.png", p_final, dpi = 300)  #, width = 4, height = 5
